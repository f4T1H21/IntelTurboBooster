...
directory="/sys/devices/system/cpu/intel_pstate/" # The default directory for intel_pstate driver.
...
Your system either doesn't have intel_pstate driver or there are files missing in the directory.
If you have the driver directory but not in default location, change the directory in the code.
[i] See https://github.com/f4T1H21/IntelTurboBooster#troubleshooting for troubleshoot.
................................................................................................
EOS
    exit 16
fi
...
[!] This tool is only for Intel® CPUs supporting intel_pstate driver.
[!] Use at your own risk, I am not responsible for any malfunction.

It's no longer hard to change Intel® Turbo Boost settings and CPU clock speed.
...
Mostly this happens when hardware is NOT able to write into Turbo Boost files.
You can still change clock speed and view your current CPU status.
[i] See https://github.com/f4T1H21/IntelTurboBooster#troubleshooting
..............................................................................
EOS
if [[ $arg1 = "-h" && $arg2 = "" && $arg3 = "" || $arg1 = "--help" && $arg2 = "" && $arg3 = "" ]]; then # Start checking arguments.
    ...
    echo ${arg1} | sudo tee ${directory}min_perf_pct 1>/dev/null && echo "[+] Set minimum CPU clock speed: ${arg1}" || echo "[E] An unexpected error occured!" # Set minimum clock speed by writing into min_perf_pct file.
    echo ${arg2} | sudo tee ${directory}max_perf_pct 1>/dev/null && echo "[+] Set maximum CPU clock speed: ${arg2}" || echo "[E] An unexpected error occured!" # Set minimum clock speed by writing into max_perf_pct file.
    exit 0
